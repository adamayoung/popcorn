...
let package = Package(
    ...
    products: [
        .library(name: "PeopleKitAdapters", targets: ["PeopleKitAdapters"])
    ],
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "PeopleDomain", package: "PeopleKit"),
                .product(name: "PeopleInfrastructure", package: "PeopleKit"),
