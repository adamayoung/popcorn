...
public final class MockAnalyticsProvider: AnalyticsProviding, @unchecked Sendable {

    public var isInitialised: Bool = false

    public private(set) var startCallCount = 0
    public private(set) var lastStartConfig: AnalyticsConfiguration?
    ...
    public func start(_ config: AnalyticsConfiguration) async throws {
        startCallCount += 1
