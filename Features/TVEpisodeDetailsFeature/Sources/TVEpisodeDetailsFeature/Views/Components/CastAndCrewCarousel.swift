    ...
    var body: some View {
        Carousel {
            ForEach(castMembers) { castMember in
                ...
                .accessibilityIdentifier("tv-episode-details.cast-and-crew.cast.\(castMember.id)")
            ...
            ForEach(crewMembers) { crewMember in
                ...
                .accessibilityIdentifier("tv-episode-details.cast-and-crew.crew.\(crewMember.id)")
        ...
        .accessibilityIdentifier("tv-episode-details.cast-and-crew.carousel")
