...
/// The MVVM games catalog screen, driven by ``GamesCatalogViewModel``.
///
/// Renders the same grid / card markup, loading, and error chrome of the former
/// `GamesCatalogView`, so recorded snapshots stay byte-identical.
public struct GamesCatalogScreen: View {
