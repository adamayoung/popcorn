...
/// exact toolbar / loading / error chrome of the former `FeatureFlagsView`.
...
extension FeatureFlagsScreen {
    ...
    #Preview("Loading") {
        NavigationStack {
            FeatureFlagsScreen(viewModel: .preview(viewState: .loading))
        }
    }
