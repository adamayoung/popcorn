...
/// `popular-movies` context, and that carousel is still mounted in the same
...
struct TransitionID {
    ...
    /// The context used by the popular movies grid.
    static let gridContext = "popular-movies-grid"
