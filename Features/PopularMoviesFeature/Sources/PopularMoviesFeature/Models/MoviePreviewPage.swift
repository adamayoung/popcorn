...
/// A single page of popular movie previews for presentation.
///
/// Carries the ``MoviePreview`` values on one page together with the pagination
/// metadata ``PopularMoviesViewModel`` needs to decide whether to request another
/// page.
public struct MoviePreviewPage: Equatable, Sendable {
    ...
    /// The popular movie previews on this page.
    ...
    /// Creates a new page of popular movie previews.
    ///
    /// - Parameters:
    ///   - page: The number of this page, starting at `1`.
    ///   - totalPages: The total number of pages available.
    ///   - movies: The popular movie previews on this page.
