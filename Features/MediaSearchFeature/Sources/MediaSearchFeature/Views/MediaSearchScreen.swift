...
///
/// Renders the same genres / search history / results / no-results surfaces as the
/// former store-based `MediaSearchView`, reusing the store-free content subviews.
...
public struct MediaSearchScreen: View {
