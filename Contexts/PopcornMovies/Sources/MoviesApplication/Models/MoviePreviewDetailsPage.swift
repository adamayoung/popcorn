...
///
/// A single page of detailed movie previews.
///
...
public struct MoviePreviewDetailsPage: Equatable, Sendable {
    ...
    /// The detailed movie previews on this page.
    public let movies: [MoviePreviewDetails]

    ///
    /// Creates a new page of detailed movie previews.
    ///
    /// - Parameters:
    ///   - page: The number of this page, starting at `1`.
    ///   - totalPages: The total number of pages available.
    ///   - movies: The detailed movie previews on this page.
    ///
