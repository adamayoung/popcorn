...
///
/// A single page of detailed discovered movie previews.
///
...
public struct MoviePreviewDetailsPage: Equatable, Sendable {
    ...
    /// The detailed discovered movie previews on this page.
    public let movies: [MoviePreviewDetails]

    ///
    /// Creates a new page of detailed discovered movie previews.
    ///
    /// - Parameters:
    ///   - page: The number of this page, starting at `1`.
    ///   - totalPages: The total number of pages available.
    ///   - movies: The detailed discovered movie previews on this page.
    ///
